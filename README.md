...
![Контекстная диаграмма](docs/diagrams/IDEF0/01_A-0.png)

![Детализированная диаграмма первого уровня](docs/diagrams/IDEF0/02_A0.png)

![Детализированная диаграмма процесса регистрации транспортных средств](docs/diagrams/IDEF0/03_A1.png)

![Детализированная диаграмма процесса учёта транспортных средств](docs/diagrams/IDEF0/04_A2.png)

![Детализированная диаграмма процесса предоставления услуг аренды](docs/diagrams/IDEF0/05_A3.png)

![Детализированная диаграмма процесса формирования отчётов](docs/diagrams/IDEF0/06_A4.png)

### Диаграмма прецедентов (Use Case)
Описание ролей пользователей и их возможностей.

![Диаграмма прецедентов до автоматизации](docs/diagrams/UML/UseCaseDiagram1.png)

![Диаграмма прецедентов после автоматизации](docs/diagrams/UML/UseCaseDiagram2.png)

### Диаграмма классов
Основная структура данных и связи между сущностями.

![Диаграмма классов](docs/diagrams/UML/ClassDiagram1.png)

### Диаграмма последовательности
Пример процесса оформления аренды автомобиля.

![Диаграмма последовательности до автоматизации](docs/diagrams/UML/SequenceDiagram1.png)

![Диаграмма последовательности после автоматизации](docs/diagrams/UML/SequenceDiagram2.png)
